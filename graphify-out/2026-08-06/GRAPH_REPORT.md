...
Cohesion: 0.13
Nodes (17): Employee, EmployeePerformanceAnalysisPage(), EMPTY_SUMMARY, formatDate(), formatNumber(), initials(), MetricCard(), MetricCardProps (+9 more)
...
Cohesion: 0.06
Nodes (44): AiVoicePage(), duration(), EMPTY_FILTERS, Filters, formatDateTime(), formatTranscriptForClipboard(), labelStyles, labelText() (+36 more)

### Community 5 - "hni-clients/page.tsx"
Cohesion: 0.11
...
Cohesion: 0.06
Nodes (38): CallListDialog(), CallListEntry, CallListStatus, CLIENT_STATUS_MAP, Crm, EMPTY_LEADS, initials(), isFresh() (+30 more)
...
### Community 13 - "cn"
Cohesion: 0.06
Nodes (50): BreadcrumbEllipsis(), BreadcrumbItem(), BreadcrumbLink(), BreadcrumbList(), BreadcrumbPage(), BreadcrumbSeparator(), DialogOverlay(), InputGroup() (+42 more)
...
Cohesion: 0.06
Nodes (44): aiModules, recentActions, change(), CHART_COLORS, Employee, localDate(), ReportResponse, ReportsPage() (+36 more)
...
Cohesion: 0.07
Nodes (44): categoryConfig, Document, DocumentsPage(), getFileColor(), getFileIcon(), initialDocuments, ActionButton(), buildFollowUpNotifications() (+36 more)
...
Cohesion: 0.13
Nodes (18): AuthModule, Module, BookingsModule, Module, ClientsModule, Module, LeadActivityModule, Module (+10 more)
...
Cohesion: 0.10
Nodes (31): EmployeesPage(), CALL_STATUS_COLORS, fmtDate(), fmtDateTime(), HWC_META, initials(), isOverdue(), isToday() (+23 more)
...
Cohesion: 0.19
Nodes (18): container, formatPropertyType(), formatStatus(), getAIRecommendations(), getConfigurationSummary(), getPitchReadiness(), getStatusClass(), getVisitNote() (+10 more)
...
### Community 78 - "react"
Cohesion: 0.09
Nodes (20): DashboardLayout(), SplashPage(), AppSidebar(), CommandPalette(), TopNav(), QueryProvider(), PrivacyGuard(), Calendar() (+12 more)
...
Cohesion: 0.22
Nodes (4): humanize(), Injectable, WebsiteLead, WebsiteLeadSyncService
...
### Community 251 - "voice-integration.module.ts"
Cohesion: 0.33
Nodes (5): DatabaseModule, Module, Module, VoiceIntegrationModule, Global
...
### Community 262 - "accordion.tsx"
Cohesion: 0.40
Nodes (3): AccordionContent(), AccordionItem(), AccordionTrigger()

## Knowledge Gaps
- **887 isolated node(s):** `{ handler }`, `$schema`, `collection`, `sourceRoot`, `deleteOutDir` (+882 more)
...
- **Why does `react` connect `react` to `employee-performance-analysis/page.tsx`, `carousel.tsx`, `dashboard/page.tsx`, `dependencies`, `form.tsx`, `toggle-group.tsx`, `properties/page.tsx`, `cn`, `hooks/use-toast.ts`, `chart.tsx`, `settings/page.tsx`, `WhatsAppHubPage`, `documents/page.tsx`?**
