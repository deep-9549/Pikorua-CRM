          ...
          <>
            ...
            >
              ...
              <div className={cn("h-full flex-col", selected ? "hidden sm:flex sm:w-[420px]" : "flex w-full sm:w-[420px]")}
                ...
                {/* Header */}
                <div className="flex items-start justify-between gap-2 px-3 py-3 shrink-0 sm:items-center sm:px-5 sm:py-4"
                  ...
                  <div className="flex shrink-0 items-center gap-0.5 sm:gap-1.5">
                    <Button variant="ghost" size="sm" className="h-8 px-2 text-[11px] text-muted-foreground" onClick={markAllRead}>
                      <CheckCircle2 className="w-3 h-3 mr-1" />All read
                    </Button>
                    <Button variant="ghost" size="icon-sm" className="h-8 w-8 text-muted-foreground sm:w-auto sm:px-2" onClick={clearRead} aria-label="Clear read notifications">
                      <Trash2 className="w-3 h-3" /><span className="hidden sm:inline">Clear</span>
                    </Button>
                    <button onClick={closePanel}
                      className="h-9 w-9 flex items-center justify-center rounded-lg hover:bg-muted transition-colors" aria-label="Close notifications">
                ...
                {/* Filter bar */}
                <div className="px-3 py-2.5 flex items-center gap-2 shrink-0 sm:px-4"
                  style={{ borderBottom: "1px solid var(--color-border)" }}>
