...
export function serializeMetaLead(lead: any) {
  ...
  return {
    ...
    legacy_import: Boolean(lead.legacyImport ?? lead.legacy_import),
    legacy_transfer_protected: Boolean(lead.legacyTransferProtected ?? lead.legacy_transfer_protected),
